 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(3),n=e(0);function s(A,t){null==t&&(t={}),null==t.ambisonicOrder&&(t.ambisonicOrder=n.DEFAULT_AMBISONIC_ORDER),null==t.azimuth&&(t.azimuth=n.DEFAULT_AZIMUTH),null==t.elevation&&(t.elevation=n.DEFAULT_ELEVATION),null==t.sourceWidth&&(t.sourceWidth=n.DEFAULT_SOURCE_WIDTH),this._context=A,this.input=A.createGain(),this._channelGain=[],this._merger=void 0,this.output=A.createGain(),this.setAmbisonicOrder(t.ambisonicOrder),this._azimuth=t.azimuth,this._elevation=t.elevation,this.setSourceWidth(t.sourceWidth)}s.prototype.setAmbisonicOrder=function(A){this._ambisonicOrder=s.validateAmbisonicOrder(A),this.input.disconnect();for(let e=0;e<this._channelGain.length;e++)this._channelGain[e].disconnect();null!=this._merger&&this._merger.disconnect(),delete this._channelGain,delete this._merger;let t=(this._ambisonicOrder+1)*(this._ambisonicOrder+1);this._merger=this._context.createChannelMerger(t),this._channelGain=new Array(t);for(let e=0;e<t;e++)this._channelGain[e]=this._context.createGain(),this.input.connect(this._channelGain[e]),this._channelGain[e].connect(this._merger,0,e);this._merger.connect(this.output)},s.prototype.setDirection=function(A,t){(null==A||isNaN(A))&&(A=n.DEFAULT_AZIMUTH),(null==t||isNaN(t))&&(t=n.DEFAULT_ELEVATION),this._azimuth=A,this._elevation=t,(A=Math.round(A%360))<0&&(A+=360),t=Math.round(Math.min(90,Math.max(-90,t)))+90,this._channelGain[0].gain.value=i.MAX_RE_WEIGHTS[this._spreadIndex][0];for(let e=1;e<=this._ambisonicOrder;e++){let n=i.MAX_RE_WEIGHTS[this._spreadIndex][e];for(let s=-e;s<=e;s++){let o=e*e+e+s,r=e*(e+1)/2+Math.abs(s)-1,a=i.SPHERICAL_HARMONICS[1][t][r];if(0!=s){let t=i.SPHERICAL_HARMONICS_MAX_ORDER+s-1;s<0&&(t=i.SPHERICAL_HARMONICS_MAX_ORDER+s),a*=i.SPHERICAL_HARMONICS[0][A][t]}this._channelGain[o].gain.value=a*n}}},s.prototype.setSourceWidth=function(A){this._spreadIndex=Math.min(359,Math.max(0,Math.round(A))),this.setDirection(this._azimuth,this._elevation)},s.validateAmbisonicOrder=function(A){return isNaN(A)||null==A?(n.log("Error: Invalid ambisonic order",options.ambisonicOrder,"\nUsing ambisonicOrder=1 instead."),A=1):A<1?(n.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Min order is 1)","\nUsing min order instead."),A=1):A>i.SPHERICAL_HARMONICS_MAX_ORDER&&(n.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Max order is",i.SPHERICAL_HARMONICS_MAX_ORDER,")\nUsing max order instead."),options.ambisonicOrder=i.SPHERICAL_HARMONICS_MAX_ORDER),A},A.exports=s},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(5),n=e(6),s=e(1),o=e(0);function r(A,t){null==t&&(t={}),null==t.position&&(t.position=o.DEFAULT_POSITION.slice()),null==t.forward&&(t.forward=o.DEFAULT_FORWARD.slice()),null==t.up&&(t.up=o.DEFAULT_UP.slice()),null==t.minDistance&&(t.minDistance=o.DEFAULT_MIN_DISTANCE),null==t.maxDistance&&(t.maxDistance=o.DEFAULT_MAX_DISTANCE),null==t.rolloff&&(t.rolloff=o.DEFAULT_ROLLOFF),null==t.gain&&(t.gain=o.DEFAULT_SOURCE_GAIN),null==t.alpha&&(t.alpha=o.DEFAULT_DIRECTIVITY_ALPHA),null==t.sharpness&&(t.sharpness=o.DEFAULT_DIRECTIVITY_SHARPNESS),null==t.sourceWidth&&(t.sourceWidth=o.DEFAULT_SOURCE_WIDTH),this._scene=A,this._position=t.position,this._forward=t.forward,this._up=t.up,this._dx=new Float32Array(3),this._right=o.crossProduct(this._forward,this._up);let e=A._context;this.input=e.createGain(),this._directivity=new i(e,{alpha:t.alpha,sharpness:t.sharpness}),this._toEarly=e.createGain(),this._toLate=e.createGain(),this._attenuation=new n(e,{minDistance:t.minDistance,maxDistance:t.maxDistance,rolloff:t.rolloff}),this._encoder=new s(e,{ambisonicOrder:A._ambisonicOrder,sourceWidth:t.sourceWidth}),this.input.connect(this._toLate),this._toLate.connect(A._room.late.input),this.input.connect(this._attenuation.input),this._attenuation.output.connect(this._toEarly),this._toEarly.connect(A._room.early.input),this._attenuation.output.connect(this._directivity.input),this._directivity.output.connect(this._encoder.input),this._encoder.output.connect(A._listener.input),this.setPosition(t.position[0],t.position[1],t.position[2]),this.input.gain.value=t.gain}r.prototype.setPosition=function(A,t,e){this._position[0]=A,this._position[1]=t,this._position[2]=e;let i=function(A){let t=1;A>o.EPSILON_FLOAT&&(t=1-A/o.SOURCE_MAX_OUTSIDE_ROOM_DISTANCE,t=Math.max(0,Math.min(1,t)));return t}(this._scene._room.getDistanceOutsideRoom(this._position[0],this._position[1],this._position[2]));this._toLate.gain.value=i,this._toEarly.gain.value=i,this._update()},r.prototype._update=function(){for(let i=0;i<3;i++)this._dx[i]=this._position[i]-this._scene._listener.position[i];let A=Math.sqrt(this._dx[0]*this._dx[0]+this._dx[1]*this._dx[1]+this._dx[2]*this._dx[2]);A>0&&(this._dx[0]/=A,this._dx[1]/=A,this._dx[2]/=A);let t=Math.atan2(-this._dx[0],this._dx[2])*o.RADIANS_TO_DEGREES,e=Math.atan2(this._dx[1],Math.sqrt(this._dx[0]*this._dx[0]+this._dx[2]*this._dx[2]))*o.RADIANS_TO_DEGREES;this._attenuation.setDistance(A),this._directivity.computeAngle(this._forward,this._dx),this._encoder.setDirection(t,e)},r.prototype.setRolloff=function(A){this._attenuation.setRolloff(A)},r.prototype.setMinDistance=function(A){this._attenuation.minDistance=A},r.prototype.setMaxDistance=function(A){this._attenuation.maxDistance=A},r.prototype.setGain=function(A){this.input.gain.value=A},r.prototype.setOrientation=function(A,t,e,i,n,s){this._forward[0]=A,this._forward[1]=t,this._forward[2]=e,this._up[0]=i,this._up[1]=n,this._up[2]=s,this._right=o.crossProduct(this._forward,this._up)},r.prototype.setFromMatrix=function(A){this._right[0]=A.elements[0],this._right[1]=A.elements[1],this._right[2]=A.elements[2],this._up[0]=A.elements[4],this._up[1]=A.elements[5],this._up[2]=A.elements[6],this._forward[0]=A.elements[8],this._forward[1]=A.elements[9],this._forward[2]=A.elements[10],this._right=o.normalizeVector(this._right),this._up=o.normalizeVector(this._up),this._forward=o.normalizeVector(this._forward),this.setPosition(A.elements[12],A.elements[13],A.elements[14])},r.prototype.setSourceWidth=function(A){this._encoder.setSourceWidth(A),this.setPosition(this._position[0],this._position[1],this._position[2])},r.prototype.setDirectivityPattern=function(A,t){this._directivity.setPattern(A,t),this.setPosition(this._position[0],this._position[1],this._position[2])},A.exports=r},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(0);function n(A,t){null==t&&(t={}),null==t.alpha&&(t.alpha=i.DEFAULT_DIRECTIVITY_ALPHA),null==t.sharpness&&(t.sharpness=i.DEFAULT_DIRECTIVITY_SHARPNESS),this._context=A,this._lowpass=A.createBiquadFilter(),this._lowpass.type="lowpass",this._lowpass.Q.value=0,this._lowpass.frequency.value=.5*A.sampleRate,this._cosTheta=0,this.setPattern(t.alpha,t.sharpness),this.input=this._lowpass,this.output=this._lowpass}n.prototype.computeAngle=function(A,t){let e=i.normalizeVector(A),n=i.normalizeVector(t),s=1;if(this._alpha>i.EPSILON_FLOAT){let A=e[0]*n[0]+e[1]*n[1]+e[2]*n[2];s=1-this._alpha+this._alpha*A,s=Math.pow(Math.abs(s),this._sharpness)}this._lowpass.frequency.value=.5*this._context.sampleRate*s},n.prototype.setPattern=function(A,t){this._alpha=Math.min(1,Math.max(0,A)),this._sharpness=Math.max(1,t),this.computeAngle([this._cosTheta*this._cosTheta,0,0],[1,0,0])},A.exports=n},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(0);function n(A,t){null==t&&(t={}),null==t.minDistance&&(t.minDistance=i.DEFAULT_MIN_DISTANCE),null==t.maxDistance&&(t.maxDistance=i.DEFAULT_MAX_DISTANCE),null==t.rolloff&&(t.rolloff=i.DEFAULT_ATTENUATION_ROLLOFF),this.minDistance=t.minDistance,this.maxDistance=t.maxDistance,this.setRolloff(t.rolloff),this._gainNode=A.createGain(),this.setDistance(t.maxDistance),this.input=this._gainNode,this.output=this._gainNode}n.prototype.setDistance=function(A){let t=1;if("logarithmic"==this._rolloff){if(A>this.maxDistance)t=0;else if(A>this.minDistance){let e=this.maxDistance-this.minDistance;if(e>i.EPSILON_FLOAT){let i=1/(e+1);t=(1/(A-this.minDistance+1)-i)/(1-i)}}}else if("linear"==this._rolloff)if(A>this.maxDistance)t=0;else if(A>this.minDistance){let e=this.maxDistance-this.minDistance;e>i.EPSILON_FLOAT&&(t=(this.maxDistance-A)/e)}this._gainNode.gain.value=t},n.prototype.setRolloff=function(A){let t=~i.ATTENUATION_ROLLOFFS.indexOf(A);null!=A&&t?A=A.toString().toLowerCase():(t||i.log('Invalid rolloff model ("'+A+'"). Using default: "'+i.DEFAULT_ATTENUATION_ROLLOFF+'".'),A=i.DEFAULT_ATTENUATION_ROLLOFF),this._rolloff=A},A.exports=n},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(8),n=e(9),s=e(0);function o(A){let t={};for(let e in s.DEFAULT_ROOM_MATERIALS)s.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&(t[e]=s.ROOM_MATERIAL_COEFFICIENTS[s.DEFAULT_ROOM_MATERIALS[e]]);null==A&&(A={},Object.assign(A,s.DEFAULT_ROOM_MATERIALS));for(let e in s.DEFAULT_ROOM_MATERIALS)s.DEFAULT_ROOM_MATERIALS.hasOwnProperty(e)&&A.hasOwnProperty(e)?A[e]in s.ROOM_MATERIAL_COEFFICIENTS?t[e]=s.ROOM_MATERIAL_COEFFICIENTS[A[e]]:s.log('Material "'+A[e]+'" on wall "'+e+'" not found. Using "'+s.DEFAULT_ROOM_MATERIALS[e]+'".'):s.log('Wall "'+e+'" is not defined. Default used.');return t}function r(A){null==A&&(A={});for(let t in s.DEFAULT_ROOM_DIMENSIONS)A.hasOwnProperty(t)||(A[t]=s.DEFAULT_ROOM_DIMENSIONS[t]);return A}function a(A,t,e){let i=new Float32Array(s.NUMBER_REVERB_FREQUENCY_BANDS);A=r(A),t=function(A){null==A&&(A={});for(let t in s.DEFAULT_ROOM_MATERIALS)A.hasOwnProperty(t)||(A[t]=s.ROOM_MATERIAL_COEFFICIENTS[s.DEFAULT_ROOM_MATERIALS[t]]);return A}(t),null==e&&(e=s.DEFAULT_SPEED_OF_SOUND);let n=s.TWENTY_FOUR_LOG10/e,o=A.width*A.height*A.depth;if(o<s.ROOM_MIN_VOLUME)return i;let a=A.width*A.height,h=A.width*A.depth,c=A.depth*A.height,_=2*(a+h+c);for(let r=0;r<s.NUMBER_REVERB_FREQUENCY_BANDS;r++){let A=((t.left[r]+t.right[r])*a+(t.down[r]+t.up[r])*h+(t.front[r]+t.back[r])*c)/_;i[r]=s.ROOM_EYRING_CORRECTION_COEFFICIENT*n*o/(-_*Math.log(1-A)+4*s.ROOM_AIR_ABSORPTION_COEFFICIENTS[r]*o)}return i}function h(A){let t=[];for(let e in s.DEFAULT_REFLECTION_COEFFICIENTS)if(s.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)){t[e]=0;for(let i=0;i<s.NUMBER_REFLECTION_AVERAGING_BANDS;i++){let n=i+s.ROOM_STARTING_AVERAGING_BAND;t[e]+=A[e][n]}t[e]/=s.NUMBER_REFLECTION_AVERAGING_BANDS,t[e]=Math.sqrt(1-t[e])}return t}function c(A,t){null==t&&(t={}),null==t.listenerPosition&&(t.listenerPosition=s.DEFAULT_POSITION.slice()),null==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,s.DEFAULT_ROOM_DIMENSIONS)),null==t.materials&&(t.materials={},Object.assign(t.materials,s.DEFAULT_ROOM_MATERIALS)),null==t.speedOfSound&&(t.speedOfSound=s.DEFAULT_SPEED_OF_SOUND),t.dimensions=r(t.dimensions);let e=o(t.materials),c=h(e),_=a(t.dimensions,e,t.speedOfSound);this.early=new n(A,{dimensions:t.dimensions,coefficients:c,speedOfSound:t.speedOfSound,listenerPosition:t.listenerPosition}),this.late=new i(A,{durations:_}),this.speedOfSound=t.speedOfSound,this.output=A.createGain(),this.early.output.connect(this.output),this._merger=A.createChannelMerger(4),this.late.output.connect(this._merger,0,0),this._merger.connect(this.output)}c.prototype.setProperties=function(A,t){let e=o(t),i=a(A,e,this.speedOfSound);this.late.setDurations(i),this.early.speedOfSound=this.speedOfSound;let n=h(e);this.early.setRoomProperties(A,n)},c.prototype.setListenerPosition=function(A,t,e){this.early.speedOfSound=this.speedOfSound,this.early.setListenerPosition(A,t,e);let i=this.getDistanceOutsideRoom(A,t,e),n=1;i>s.EPSILON_FLOAT&&(n=1-i/s.LISTENER_MAX_OUTSIDE_ROOM_DISTANCE,n=Math.max(0,Math.min(1,n))),this.output.gain.value=n},c.prototype.getDistanceOutsideRoom=function(A,t,e){let i=Math.max(0,-this.early._halfDimensions.width-A,A-this.early._halfDimensions.width),n=Math.max(0,-this.early._halfDimensions.height-t,t-this.early._halfDimensions.height),s=Math.max(0,-this.early._halfDimensions.depth-e,e-this.early._halfDimensions.depth);return Math.sqrt(i*i+n*n+s*s)},A.exports=c},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(0);function n(A,t){null==t&&(t={}),null==t.durations&&(t.durations=i.DEFAULT_REVERB_DURATIONS.slice()),null==t.predelay&&(t.predelay=i.DEFAULT_REVERB_PREDELAY),null==t.gain&&(t.gain=i.DEFAULT_REVERB_GAIN),null==t.bandwidth&&(t.bandwidth=i.DEFAULT_REVERB_BANDWIDTH),null==t.tailonset&&(t.tailonset=i.DEFAULT_REVERB_TAIL_ONSET);let e=t.predelay/1e3;this._bandwidthCoeff=t.bandwidth*i.LOG2_DIV2,this._tailonsetSamples=t.tailonset/1e3,this._context=A,this.input=A.createGain(),this._predelay=A.createDelay(e),this._convolver=A.createConvolver(),this.output=A.createGain(),this.output.gain.value=t.gain,this._convolver.normalize=!1,this.input.connect(this._predelay),this._predelay.connect(this._convolver),this._convolver.connect(this.output),this.setDurations(t.durations)}n.prototype.setDurations=function(A){if(A.length!==i.NUMBER_REVERB_FREQUENCY_BANDS)return void i.log("Warning: invalid number of RT60 values provided to reverb.");let t=new Float32Array(i.NUMBER_REVERB_FREQUENCY_BANDS),e=this._context.sampleRate;for(let h=0;h<A.length;h++)A[h]=Math.max(0,Math.min(i.DEFAULT_REVERB_MAX_DURATION,A[h])),t[h]=Math.round(A[h]*e*i.DEFAULT_REVERB_DURATION_MULTIPLIER);let n=0;for(let i=0;i<t.length;i++)t[i]>n&&(n=t[i]);n<1&&(n=1);let s=this._context.createBuffer(1,n,e),o=s.getChannelData(0),r=new Float32Array(n);for(let i=0;i<n;i++)r[i]=2*Math.random()-1;for(let h=0;h<i.NUMBER_REVERB_FREQUENCY_BANDS;h++){let A=-i.LOG1000/t[h],n=i.TWO_PI*i.DEFAULT_REVERB_FREQUENCY_BANDS[h]/e,s=Math.sin(n),a=s*Math.sinh(this._bandwidthCoeff*n/s),c=1/(1+a),_=a*c,l=-2*Math.cos(n)*c,D=(1-a)*c,f=0,u=0;for(let e=0;e<t[h];e++){let t=r[e]*Math.exp(A*e)-l*f-D*u;o[e]+=_*(t-u),u=f,f=t}}let a=Math.round(this._tailonsetSamples);for(let h=0;h<Math.min(o.length,a);h++){let A=.5*(1-Math.cos(i.TWO_PI*h/(2*a-1)));o[h]*=A}this._convolver.buffer=s},A.exports=n},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(0);function n(A,t){null==t&&(t={}),null==t.speedOfSound&&(t.speedOfSound=i.DEFAULT_SPEED_OF_SOUND),null==t.listenerPosition&&(t.listenerPosition=i.DEFAULT_POSITION.slice()),null==t.coefficients&&(t.coefficients={},Object.assign(t.coefficients,i.DEFAULT_REFLECTION_COEFFICIENTS)),this.speedOfSound=t.speedOfSound,this.input=A.createGain(),this.output=A.createGain(),this._lowpass=A.createBiquadFilter(),this._delays={},this._gains={},this._inverters={},this._merger=A.createChannelMerger(4);for(let e in i.DEFAULT_REFLECTION_COEFFICIENTS)i.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)&&(this._delays[e]=A.createDelay(i.MAX_DURATION),this._gains[e]=A.createGain());this._inverters.right=A.createGain(),this._inverters.down=A.createGain(),this._inverters.back=A.createGain(),this._lowpass.type="lowpass",this._lowpass.frequency.value=i.DEFAULT_REFLECTION_CUTOFF_FREQUENCY,this._lowpass.Q.value=0;for(let e in i.DEFAULT_REFLECTION_COEFFICIENTS)i.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)&&(this._delays[e].delayTime.value=0,this._gains[e].gain.value=0);this._inverters.right.gain.value=-1,this._inverters.down.gain.value=-1,this._inverters.back.gain.value=-1,this.input.connect(this._lowpass);for(let e in i.DEFAULT_REFLECTION_COEFFICIENTS)i.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(e)&&(this._lowpass.connect(this._delays[e]),this._delays[e].connect(this._gains[e]),this._gains[e].connect(this._merger,0,0));this._gains.left.connect(this._merger,0,1),this._gains.right.connect(this._inverters.right),this._inverters.right.connect(this._merger,0,1),this._gains.up.connect(this._merger,0,2),this._gains.down.connect(this._inverters.down),this._inverters.down.connect(this._merger,0,2),this._gains.front.connect(this._merger,0,3),this._gains.back.connect(this._inverters.back),this._inverters.back.connect(this._merger,0,3),this._merger.connect(this.output),this._listenerPosition=t.listenerPosition,this.setRoomProperties(t.dimensions,t.coefficients)}n.prototype.setListenerPosition=function(A,t,e){this._listenerPosition=[A,t,e];let n={left:i.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.width+A)+i.DEFAULT_REFLECTION_MIN_DISTANCE,right:i.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.width-A)+i.DEFAULT_REFLECTION_MIN_DISTANCE,front:i.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.depth+e)+i.DEFAULT_REFLECTION_MIN_DISTANCE,back:i.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.depth-e)+i.DEFAULT_REFLECTION_MIN_DISTANCE,down:i.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.height+t)+i.DEFAULT_REFLECTION_MIN_DISTANCE,up:i.DEFAULT_REFLECTION_MULTIPLIER*Math.max(0,this._halfDimensions.height-t)+i.DEFAULT_REFLECTION_MIN_DISTANCE};for(let s in i.DEFAULT_REFLECTION_COEFFICIENTS)if(i.DEFAULT_REFLECTION_COEFFICIENTS.hasOwnProperty(s)){let A=n[s]/this.speedOfSound;this._delays[s].delayTime.value=A;let t=this._coefficients[s]/n[s];this._gains[s].gain.value=t}},n.prototype.setRoomProperties=function(A,t){null==A&&(A={},Object.assign(A,i.DEFAULT_ROOM_DIMENSIONS)),null==t&&(t={},Object.assign(t,i.DEFAULT_REFLECTION_COEFFICIENTS)),this._coefficients=t,this._halfDimensions={},this._halfDimensions.width=.5*A.width,this._halfDimensions.height=.5*A.height,this._halfDimensions.depth=.5*A.depth,this.setListenerPosition(this._listenerPosition[0],this._listenerPosition[1],this._listenerPosition[2])},A.exports=n},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(11);i.Attenuation=e(6),i.Directivity=e(5),i.EarlyReflections=e(9),i.Encoder=e(1),i.LateReflections=e(8),i.Listener=e(2),i.Room=e(7),i.Source=e(4),i.Tables=e(3),i.Utils=e(0),i.Version=e(13),A.exports=i},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(2),n=e(4),s=e(7),o=e(1),r=e(0);function a(A,t){null==t&&(t={}),null==t.ambisonicOrder&&(t.ambisonicOrder=r.DEFAULT_AMBISONIC_ORDER),null==t.listenerPosition&&(t.listenerPosition=r.DEFAULT_POSITION.slice()),null==t.listenerForward&&(t.listenerForward=r.DEFAULT_FORWARD.slice()),null==t.listenerUp&&(t.listenerUp=r.DEFAULT_UP.slice()),null==t.dimensions&&(t.dimensions={},Object.assign(t.dimensions,r.DEFAULT_ROOM_DIMENSIONS)),null==t.materials&&(t.materials={},Object.assign(t.materials,r.DEFAULT_ROOM_MATERIALS)),null==t.speedOfSound&&(t.speedOfSound=r.DEFAULT_SPEED_OF_SOUND),this._ambisonicOrder=o.validateAmbisonicOrder(t.ambisonicOrder),this._sources=[],this._room=new s(A,{listenerPosition:t.listenerPosition,dimensions:t.dimensions,materials:t.materials,speedOfSound:t.speedOfSound}),this._listener=new i(A,{ambisonicOrder:t.ambisonicOrder,position:t.listenerPosition,forward:t.listenerForward,up:t.listenerUp}),this._context=A,this.output=A.createGain(),this.ambisonicOutput=A.createGain(),this.ambisonicInput=this._listener.input,this._room.output.connect(this._listener.input),this._listener.output.connect(this.output),this._listener.ambisonicOutput.connect(this.ambisonicOutput)}a.prototype.createSource=function(A){let t=new n(this,A);return this._sources[this._sources.length]=t,t},a.prototype.setAmbisonicOrder=function(A){this._ambisonicOrder=o.validateAmbisonicOrder(A)},a.prototype.setRoomProperties=function(A,t){this._room.setProperties(A,t)},a.prototype.setListenerPosition=function(A,t,e){this._listener.position[0]=A,this._listener.position[1]=t,this._listener.position[2]=e,this._room.setListenerPosition(A,t,e),this._sources.forEach(function(A){A._update()})},a.prototype.setListenerOrientation=function(A,t,e,i,n,s){this._listener.setOrientation(A,t,e,i,n,s)},a.prototype.setListenerFromMatrix=function(A){this._listener.setFromMatrix(A),this.setListenerPosition(this._listener.position[0],this._listener.position[1],this._listener.position[2])},a.prototype.setSpeedOfSound=function(A){this._room.speedOfSound=A},A.exports=a},function(A,t){
/**
 * @license
